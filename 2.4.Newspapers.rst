...
This led to a paradigmatic pattern, which I'll call the "communication wave", that was repeated 4 times:
...
In the 1930s, "zines" containing fiction stories that were produced using spirit duplicating "ditto machines" permitted publications with circulation even in the hundreds to be feasible. The mass democratization made possible by these machines may have played significant roles in social movements of the era.  Because the publications were sustainable on such low circulation numbers. For instance, ONE magazine, a periodical advocating for things such as gay marriage and equal rights, started publishing in 1952, 17 years before the stonewall riots. This was followed 3 years later by the Mattachine Society (founded 1950), starting up their own gay rights publication, the Mattachine Review. 

The photocopier as a printing press for the masses became increasingly practical. Machines such as the Xerox 914 could be rented monthly at 0.3% the cost of buying it outright (about $775/month in 2019 dollars). This meant it could be commercially rented and made available to the public in a timeshare system (like a copy shop or one machine responsible for multiple publications).
